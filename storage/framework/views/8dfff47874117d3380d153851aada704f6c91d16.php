        ...
        <div class="event-container">
            <div class="event-short-info" onclick="window.location.href='/admin/event/<?php echo e($value->event_code); ?>'">
                ...
                <div class="event-startend-date">
                    <?php echo e(Carbon\Carbon::parse($value->start_date)->format('d-m-Y')); ?> to
            ...
            <div class="event-action">
                ...
                <ul class="event-action-mobile">
                    ...
                    <li><button class="btn btn-outline-success" data-id="<?php echo e($value->id); ?>"
                            data-code="<?php echo e($value->event_code); ?>" data-name="<?php echo e($value->event_name); ?>"
                            data-description="<?php echo e($value->event_description); ?>" data-link="<?php echo e($value->event_link); ?>"
                            data-mod="<?php echo e($value->setting_moderation); ?>" data-start="<?php echo e($value->start_date); ?>"
                            data-end="<?php echo e($value->end_date); ?>" data-join="<?php echo e($value->setting_join); ?>"
                            data-question="<?php echo e($value->setting_question); ?>" data-reply="<?php echo e($value->setting_reply); ?>"
                            data-anonymous="<?php echo e($value->setting_anonymous); ?>" data-toggle="modal"
                            data-target="#edit">Edit</button></li>
                    <li><button type="button" class="btn btn-outline-danger" data-id="<?php echo e($value->id); ?>"
                ...
                <button type="button" class="btn btn-outline-success desktop-btn" data-id="<?php echo e($value->id); ?>"
                    ...
                    data-end="<?php echo e($value->end_date); ?>" data-join="<?php echo e($value->setting_join); ?>"
                    data-question="<?php echo e($value->setting_question); ?>" data-reply="<?php echo e($value->setting_reply); ?>"
                    data-anonymous="<?php echo e($value->setting_anonymous); ?>" data-toggle="modal" data-target="#edit"><i
                        class="fa fa-edit"></i>
                </button>
                ...
                <button type="button" class="btn btn-outline-danger desktop-btn" data-id="<?php echo e($value->id); ?>"
