        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col">
                    <div class="row_col_text">
                        <div class="text_title_content">
                            <h1>Your questions are sent quickly</h1>
                            <p>
                                <span>All your questions will be sent to us quickly and can be anonymous.
                ...
                <div class="col">
                    <div class="row_col_text">
                        <div class="text_title_content">
                            <h1>Vote in real time</h1>
                            <p>
                                <span>Multiple choice questions will be created for participants.
