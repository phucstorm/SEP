    ...
    <div class="row question">
        <div class="col-6">
            <div class="content">
                ...
                <div class="question-item">
                    <div>Question: <?php echo e($value->content); ?> by <?php echo e($value->user_name); ?></div>
                    <div>ID: <?php echo e($value->id); ?> by <?php echo e($value->user_name); ?></div>
                    <div class="check-question">
                        <a href="/room/question/accept/<?php echo e($value->id); ?>"><i class="fa fa-check-circle-o text-success" aria-hidden="true"></i></a>
                        <a href="/room/question/denied/<?php echo e($value->id); ?>"><i class="fa fa-times-circle-o text-success" aria-hidden="true"></i></a>
                    </div>
                </div>
        ...
        <div class="col-6">
            <div class="accept">
                ...
                <?php if($value->status == 1): ?>
                <div class="question-item">
                    <div><?php echo e($value->content); ?></div>
                    <div><?php echo e($value->user_name); ?></div>
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <div style="float:right; display: flex">
                            <div style="margin-right:1em">
                                <button class="reply-btn" type="button" data-id="<?php echo e($value->id); ?>" data-toggle="modal" data-target="#reply"><i class="fa fa-reply" aria-hidden="true"></i>Trả lời</button>
                            </div>
                            <div>
                                <button class="item-action delete-item" data-toggle="modal" data-target="#deleteQuestion" data-id="<?php echo e($value->id); ?>" data-name="<?php echo e($value->content); ?>">
...
<?php echo $__env->make('layouts.demo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEP\Lavarel\SEP\resources\views/event/detail.blade.php ENDPATH**/ ?>