...
$('.plus-answer').click(function(){
    var answer = '<div><input type="text" class="form-control" id="event_description" name="event_description" placeholder="Answer" required><button class="delete-poll-answer-btn"><i class="fa fa-trash"></i></button></div>'
